...
def seed_users():
    ...
    viktor = User(
        ...
        gender='male', preferred_genders='female', min_age=20, max_age=40, zip_code=90210, radius=5, bio='I like to jump high', dislikes=[demo5]
    )
    edktor = User(
    ...
    abcde = User(
        ...
        gender='female', preferred_genders='male', min_age=20, max_age=40, zip_code=90210, radius=5, bio="It's pronounced ab city",  dislikes=[demo5]
    )
    optimusa = User(
    ...
    micheal = User(
        ...
        min_age=30, max_age=50, zip_code=94014, radius=30, bio="I want kids, lots of them if you cannot tell by my user name. I am a manager, comedian, and a friend.", dislikes=[demo5, demo]
    )
    cupid = User(
        ...
        min_age=18, max_age=100, zip_code=94014, radius=100, bio="This cupid is loved by all and loves all", dislikes=[demo5, demo]
    )
    demo5 = User(
    ...
    brett = User(
        username='brett', email='brett@aa.io', password='password', age=51, first_name='Brett', gender='male', preferred_genders='female', min_age=30, max_age=80, zip_code=90210, radius=100, bio='I like pickleball and long walks on the beach. #retiredlyf', dislikes=[buttercup, tam, demo], likes=[inigo, optimusa, abcde]
    )
    lyn = User(
